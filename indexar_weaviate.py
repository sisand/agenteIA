...
client = weaviate.Client(
    ...
    auth_client_secret=weaviate.AuthApiKey(api_key="jRhoRcymKc4jbud6UJNPzlaE1TtQ6pPzeA0D"),
    additional_headers={"X-OpenAI-Api-Key": "SUA_OPENAI_API_KEY"}  # Apenas se estiver usando modelo built-in
)
